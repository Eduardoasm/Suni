...
export declare function updateSettings(update: UpdateQuery<ISetting> | UpdateWithAggregationPipeline): Promise<import("mongodb").UpdateResult | (import("mongoose").Document<unknown, any, ISetting> & ISetting & {
    _id: import("mongoose").Types.ObjectId;
})>;
