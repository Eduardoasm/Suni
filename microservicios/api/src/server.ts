...
import contractRouter from './components/contract/contract/contract.routes';
import currencyRouter from './components/currency/currency.routes';
import s3Router from './components/s3/s3.routes';
import settingRoutes from './components/settings/settings/settings.routes';
import transactionRoutes from './components/transaction/transaction.routes';
import userRoutes from './components/user/user/user.routes';
import walletRoutes from './components/wallet/wallet.routes';
import creditScoreRoutes from './components/creditScore/creditScore/creditScore.routes';
import loanRequestRoutes from './components/loanRequest/loanRequest.routes';
import loanOfferRoutes from './components/loanOffer/loanOffer.routes';
