...
import messageTemplateRouter from './components/messageTemplate/messageTemplate.routes';
import languageRouter from './components/language/language.routes';
import messageRouter from './components/message/message.routes';
...
async function initSever() {
  ...
  try {
    ...
    app.use('/api', messageTemplateRouter);
